#!/usr/bin/env python3
"""Validator: cicd_easy_deploy

Checks for cicd/github_actions.yml and cicd/deploy.sh containing TODO_CHECKLIST sentinel.
"""
import os
import sys
...
def main():
    files = [
        ...
        ("deploy.sh", os.path.join(ROOT, "cicd", "deploy.sh")),
    ]
    checks = []
